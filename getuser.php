    ...
    <div class="content">    
        <table width="800" align="center" border="1" bordercolor="#8a8a8a"  cellpadding="0" cellspacing="0">
            ...
            <?php  
                ...
                $zapytanie1 = "SELECT * FROM msrts_15 WHERE id_d='".$q."' AND id_c=0 ORDER BY date_time DESC LIMIT 10";
                $zapytanie2 = "SELECT * FROM msrts_15 WHERE id_d='".$q."' AND id_c=0 ORDER BY date_time DESC LIMIT 1";
                // echo"$zapytanie1";
                // echo "$number";
                ...
                echo'<div class="white">';
                    ...
                    // $number += 1;
                    echo "Pomiary wyświetlane z licznika numer ".$q."</br>";
